...
('Chile', 'CL', 'CHL'),
('China', 'CN', 'CHN'),
('China, People''s Republic of', 'CN', 'CHN'),
('Colombia', 'CO', 'COL'),
('Comoros', 'KM', 'COM'),
...
('Baker Island', 'UM', 'UMI'),
('Guam', 'GU', 'GUM'),
('Howland Island', 'UM', 'UMI'),
('Jarvis Island', 'UM', 'UMI'),
('Johnston Atoll', 'UM', 'UMI'),
('Kingman Reef', 'UM', 'UMI'),
('Midway Islands', 'UM', 'UMI'),
('Navassa Island', 'UM', 'UMI'),
('Palmyra Atoll', 'UM', 'UMI'),
...
('Australian Antarctic Territory', 'AQ', 'ATA'),
('Ross Dependency', 'AQ', 'ATA'),
('Peter I Island', 'AQ', 'ATA'),
('Queen Maud Land', 'AQ', 'ATA'),
('British Antarctic Territory', 'AQ', 'ATA');
